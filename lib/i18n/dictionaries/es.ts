const es = {
  ...
  calculator: {
    ...
    wizard: {
      ...
      typeQuestion: "¿Qué tipo de proyecto necesitas?",
      sizeQuestion: "¿Qué tan grande es tu proyecto?",
      extrasQuestion: "¿Quieres agregar algo más?",
      extrasHint: "Selecciona los que apliquen (opcional).",
      resultTitle: "Tu estimado",
      summary: "Resumen",
      noExtras: "Sin extras",
    },
  },
