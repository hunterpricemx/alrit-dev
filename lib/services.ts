...
export const SERVICES: Service[] = [
  { id: "wordpress", slug: "sitios-wordpress", accent: "#21759b", tone: "dark", image: img("alrit-svc-wp"), icon: "M4 12a8 8 0 1 0 16 0 8 8 0 0 0-16 0Zm2 0 2.4 6.6M12 4l3 9 2.5-6.5" },
  { id: "webdev", slug: "desarrollo-web", accent: "#6c5ce7", tone: "dark", image: img("alrit-svc-web"), icon: "m8 9-3 3 3 3m8-6 3 3-3 3M13 6l-2 12" },
  { id: "lms", slug: "plataformas-lms", accent: "#ec4899", tone: "light", image: img("alrit-svc-lms"), icon: "M3 7l9-4 9 4-9 4-9-4Zm3 2v5c0 1.7 2.7 3 6 3s6-1.3 6-3V9" },
  { id: "ecommerce", slug: "ecommerce", accent: "#ff5e57", tone: "dark", image: img("alrit-svc-ecom"), icon: "M5 7h14l-1.2 9.5a2 2 0 0 1-2 1.5H8.2a2 2 0 0 1-2-1.5L5 7Zm3 0a4 4 0 0 1 8 0" },
  { id: "realestate", slug: "real-estate", accent: "#ff8a3d", tone: "light", image: img("alrit-svc-re"), icon: "M4 11 12 4l8 7M6 10v9h12v-9M10 19v-5h4v5" },
