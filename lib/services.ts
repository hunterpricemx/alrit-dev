...
export const SERVICES: Service[] = [
  ...
  { id: "lms", slug: "plataformas-lms", accent: "#0984e3", tone: "light", image: img("alrit-svc-lms"), icon: "M3 7l9-4 9 4-9 4-9-4Zm3 2v5c0 1.7 2.7 3 6 3s6-1.3 6-3V9" },
  ...
  { id: "systems", slug: "sistemas-a-medida", accent: "#fdcb6e", tone: "dark", image: img("alrit-svc-sys"), icon: "M5 4h14v12H5zM3 20h18M9 8h6M9 11h6" },
